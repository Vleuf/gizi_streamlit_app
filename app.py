...
# Database Pangan
elif page == "Database Pangan":
    st.title("Database Bahan Pangan")

    st.markdown("""
    Halaman ini memuat informasi singkat mengenai beberapa bahan pangan umum yang digunakan dalam perhitungan gizi.

    ---

    ### 1. *Nasi Putih*
    Nasi putih adalah sumber karbohidrat utama di Indonesia. Dalam 100 gram, nasi mengandung sekitar 175 kkal, 39 gram karbohidrat, serta sedikit protein dan lemak.

    ### 2. *Telur Ayam*
    Telur merupakan sumber protein hewani yang sangat baik. Mengandung sekitar 155 kkal dan 13 gram protein per 100 gram.

    ### 3. *Tempe*
    Tempe adalah sumber protein nabati hasil fermentasi kedelai. Kaya akan protein dan lemak sehat.

    ### 4. *Tahu*
    Tahu memiliki kandungan protein sedang dan cocok untuk makanan rendah kalori. Biasanya mengandung 80 kkal dan 8 gram protein per 100 gram.

    ### 5. *Daging Ayam*
    Daging ayam tanpa kulit adalah sumber protein hewani tinggi dengan sedikit kandungan karbohidrat.
